...
const Bento = ({ slice }: BentoProps): JSX.Element => {
  return (
    ...
    >
      ...
      <div className="grid-rows-[ mt-16 grid max-w-4xl grid-rows-[auto_auto_auto] gap-8 md:grid-cols-3 md:gap-10">
        {slice.items.map((item, index) => (
          <div
            className={clsx(
              "glass-container p- row-span-3 grid grid-rows-subgrid gap-4 rounded-lg bg-gradient-to-b from-gray-900 to-red-950 p-4",
