...
const CallToAction = ({ slice }: CallToActionProps): JSX.Element => {
  return (
    ...
    >
      ...
      <div className="glass-container bg rounded-lg bg-gradient-to-b from-slate-800 to-slate-900 p-4 md:rounded-xl"></div>

      <div className="mx-auto mt-8 max-w-xl text-5xl">
