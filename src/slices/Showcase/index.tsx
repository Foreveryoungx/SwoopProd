...
const Showcase = ({ slice }: ShowcaseProps): JSX.Element => {
  return (
    <Bounded
      ...
      className="relative"
    >
      <div className="glow absolute -z-10 aspect-square w-full max-w-xl rounded-full bg-red-400/20 blur-3xl filter" />
      ...
      />
      <div className="mt-16 grid items-center rounded-xl border border-red-50/20 bg-gradient-to-b from-slate-50/15 to-slate-50/5 px-8 py-8 backdrop-blur-sm lg:grid-cols-3 lg:py-12">
        <div>
          <div className="w-fit rounded-lg bg-red-500/35 p-4 text-3xl">
        ...
        <PrismicNextImage
          ...
          className={clsx(
            ...
            slice.variation === "reverse"
              ? "rounded-2xl lg:order-1 lg:translate-x-[15%]"
              : "rounded-2xl lg:-order-1 lg:translate-x-[-15%]",
          )}
        />
      </div>
